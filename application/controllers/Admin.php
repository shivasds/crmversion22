...
class Admin extends CI_Controller {
	...
	public function online_leads(){
		...
		$leadsdata_99acres = $this->acres_api();	
		$this->common_model->save_online_leads($leadsdata_magicbrick);
		$this->common_model->save_online_leads_99acres($leadsdata_99acres);
	...
	public function acres_api(){
		$url = "http://www.99acres.com/99api/v1/getmy99Response/OeAuXClO43hwseaXEQ/uid/";
		/*$username = "ps999";
		$password = "Ranviv1989";*/
		$username = "singhvivek";
		$password = "propsolution123";
		$start_date = date("Y-m-d", strtotime('yesterday'));
		$end_date = date("Y-m-d");
		$request = "<?xml version='1.0'?><query><user_name>$username</user_name><pswd>$password</pswd><start_date>2019-05-18 00:00:00</start_date><end_date>2019-05-19 23:59:59</end_date></query>";
	...
	public function save_online_leads(){
		...
		foreach ($checked as $key) {
				...
				if (!($this->callback_model->isexists_callbacks($data)))
					...
					$this->common_model->updateWhere(array('id'=>$key));
	}
	?>
